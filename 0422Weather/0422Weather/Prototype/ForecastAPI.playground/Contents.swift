...
let str = "https://apis.openapi.sk.com/weather/forecast/3days?version=2&lat=37.498206&lon=127.02761&appkey=l7xx1c33d545fe3849c5ad6cd2f72620e690"
...
let task = session.dataTask(with: url) { (data, response, error) in
    ...
    do {
        ...
        forecast.weather.forecast3days.first?.fcst3hour.sky.name10hour
        forecast.weather.forecast3days.first?.fcst3hour.sky.code10hour
